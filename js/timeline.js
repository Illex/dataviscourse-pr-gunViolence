     ...
     //   populaiton["2017"] = 0;
      //  populaiton["2018"] = 0;
       ...
       // for(let i = 0; i < this.data[1].length; i++)
        //    populaiton["2013"] = this.data[1][i].pop2013;
         //   populaiton["2014"] = this.data[1][i].pop2014;
          //  populaiton["2015"] = this.data[1][i].pop2015;
           // populaiton["2016"] = this.data[1][i].pop2016;
            //populaiton["2017"] = this.data[1][i].pop2017;
            //populaiton["2018"] = this.data[1][i].pop2018;
        //}
